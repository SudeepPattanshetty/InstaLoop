...
// Inngest Functions to update user data to a database 
...
// Inngest Functions to delete user data to a database 
...
const sendNotificationOfUnseenMessages = inngest.createFunction(
    {id: "send-unseen-messages-notifications"},
    {cron: "TZ=America/New_York 0 9 * * *"}, //Every Day 9AM
    async ({step}) => {
