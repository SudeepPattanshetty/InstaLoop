...
export const sendConnectionRequest = async (req, res) => {
    try {
        ...
        if(!connection) {
            ...
            return res.json({success: false, message: "You are already coonected with the user"})
        }
...
export const getUserConnection = async (req, res) => {
    try {
        ...
        const pendingConnections = (await Connection.findById({to_user_id: userId, status: pending}).populate('from_user_id')).map(connection => connection.from_user_id)
...
export const acceptConnectionRequest = async (req, res) => {
    try {
        ...
        if(!connection){
            return res.json({ success: true, message: "Connection not found"})
        }
